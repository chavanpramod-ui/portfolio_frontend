      ...
      <div className="bg-[var(--surface)] border border-[var(--border)] rounded-3xl p-10 shadow-xl">
        ...
        <ul className="space-y-6 text-[var(--muted)] leading-relaxed">
          {awards.map((award, idx) => (
            <li key={idx} className="rounded-3xl border border-[var(--border)] bg-[var(--surface-2)] p-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_25px_70px_rgba(0,0,0,0.08)] pop-in premium-hover">
